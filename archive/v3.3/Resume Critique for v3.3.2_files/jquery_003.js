    ...
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
                  ...
                  btPrevious = $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("button buttonPrevious");
                  btNext = $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("button buttonNext");
                  btFinish = $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("button buttonFinish");
